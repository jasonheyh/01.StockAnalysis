...
CONST_TABLE_NAME = 'sgt'
CONST_DATE = '日期'

print("#####东方财富爬虫_抓取深股通 开始#####")
...
url = 'http://dcfm.eastmoney.com/EM_MutiSvcExpandInterface/api/js/get?type=HSGTHIS&token=70f12f2f4f091e459a279469fe49eca5&filter=(MarketType=3)&js=var%20qmWKcPbd={%22data%22:(x),%22pages%22:(tp)}&ps=20&p=%page%&sr=-1&st=DetailDate&rt=50864452'
